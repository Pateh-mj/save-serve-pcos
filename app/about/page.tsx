    ...
    <div className="bg-background font-sans">
      ...
      <section className="bg-white border-b border-border py-20">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-primary mb-3">About This Project</p>
          <h1 className="text-5xl font-extrabold text-foreground mb-6">
            Patient-Centric Orchestration System
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-4">
            A Final Year BSc ICT project submitted to the Department of ICT, School of Engineering at the
            <strong className="text-foreground"> Information and Communication University (ICU)</strong>, 2026.
          </p>
          <p className="text-sm text-muted-foreground">By Patson Tembo</p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-white border border-border rounded-2xl p-8 shadow-sm mb-10">
        ...
        <div className="container mx-auto px-6 max-w-5xl grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.label} className="flex items-start gap-4 p-4 bg-white rounded-xl border border-border">
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={item.n} className="bg-white border border-border rounded-2xl p-6 shadow-sm">
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              ...
              <div key={item.title} className="bg-white border border-border rounded-2xl p-6 shadow-sm flex gap-4">
      ...
      <section className="py-14 bg-primary text-white text-center">
        ...
        <p className="text-white/70 mb-6 text-sm">Register as a patient to try the web channel, or dial *384# to test the USSD gateway.</p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/register" className="px-6 py-3 bg-white text-primary font-semibold rounded-xl hover:bg-white/90">Register as a Patient</Link>
          <Link href="/contact" className="px-6 py-3 border border-white/30 text-white font-semibold rounded-xl hover:bg-white/10">Contact the Researcher</Link>
        </div>
      </section>
    </div>
  );
